...
public class Consumer2 {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        if (conn != null) {
            ...
            // Queue
            channel.queueDeclare("CONSUMER_2", true, false, false, null);
            channel.queueBind("CONSUMER_2", ExchangeType.EXCHANGE_NAME, RouteTypes.R2.getType());

            System.out.println(" [*] Waiting for messages. To exit press CTRL+C");

            PrintStream file = new PrintStream(new FileOutputStream("professors.csv", true));
            ...
            channel.basicConsume("CONSUMER_2", true, consumer2);
